...
import { Loader2, X, Eye, EyeOff, CheckCircle } from "lucide-react";
import { useNavigate, useParams } from "react-router-dom";
import API from "../../api";

const ResetPassword = ({ isOpen, onClose, onOpenSignIn }) => {
  ...
  if (isValidToken === false) {
    return (
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-md p-4">
        <div className="bg-gray-900 border border-white/10 rounded-2xl p-6 w-full max-w-md text-center">
          ...
          <button
            ...
            className="w-full py-3 bg-blue-600 rounded-xl text-white font-semibold hover:bg-blue-700 transition-colors"
          >
            Back to Sign In
          </button>
        </div>
